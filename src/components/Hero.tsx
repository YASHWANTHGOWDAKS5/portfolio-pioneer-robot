...
const Hero: React.FC = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center py-20 overflow-hidden" ref={containerRef}>
      ...
      <div className="absolute bottom-1/3 right-1/4 opacity-20 animate-float" style={{
      animationDelay: '1s'
    }} aria-hidden="true">
        <Network className="w-10 h-10 text-secondary" />
      </div>
      <div className="absolute top-1/3 right-1/4 opacity-20 animate-float" style={{
      animationDelay: '2s'
    }} aria-hidden="true">
        <Database className="w-6 h-6 text-primary" />
      </div>
      <div className="absolute bottom-1/4 left-1/3 opacity-20 animate-float" style={{
      animationDelay: '1.5s'
    }} aria-hidden="true">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center stagger-animation">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight mb-6 md:text-3xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#projects" className="w-full sm:w-auto px-8 py-3 rounded-md bg-primary text-primary-foreground font-medium transition-all hover:bg-primary/90 hover:shadow-lg">
              View My Work
            </a>
            <a href="#about" className="w-full sm:w-auto px-8 py-3 rounded-md bg-accent text-accent-foreground font-medium border border-border transition-all hover:bg-accent/70">
              About Me
            </a>
          </div>
        </div>
